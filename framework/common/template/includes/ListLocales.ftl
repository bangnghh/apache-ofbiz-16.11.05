...
<div class="lists screenlet">
  ...
  <table cellspacing="0" class="basic-table hover-bar">
    ...
    <!--<#list availableLocales as availableLocale>
      ...
      <tr>
          <td><a href="<@ofbizUrl>setSessionLocale</@ofbizUrl>?newLocale=vi">Vietnamese(Vi-vn)</a></td>
      </tr>
      <tr>
          <td><a href="<@ofbizUrl>setSessionLocale</@ofbizUrl>?newLocale=en">English(En-eng)</a></td>
      </tr>
  </table>
</div>
